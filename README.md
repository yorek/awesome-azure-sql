...
-  [Azure SQL Database Hyperscale Named Replicas OLTP Scale-Out Samples](https://github.com/azure-samples/azure-sql-db-named-replica-oltp-scaleout/tree/main/): sample of a massively scalable OLTP backed taking advantage of database secondary replicas to offload read-only workload
