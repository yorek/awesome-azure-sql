...
- :tv: [Azure Friday: Connect your Static Web Apps to Azure Databases using REST or GraphQL | Azure Friday](https://www.youtube.com/watch?v=gCrBSSOezSQ): Build a Jamstack solution with Azure Static Web Apps and Data API Builder
