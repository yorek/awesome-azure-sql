...
- :tv: [Video 01 - Getting Started with DevOps for Azure SQL](https://www.youtube.com/watch?v=j7OnxOz7YDY): what is Data DevOps and a discussion around the first option: migration based deployment

- :tv: [Video 02 - sing Azure Pipelines for Azure SQL Deployments]((https://www.youtube.com/watch?v=G7H6HbzwAfs): discussion on state based deployment, and full demo on using Azure Pipelines to deploy the database
