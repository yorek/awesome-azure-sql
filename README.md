...
-  [Azure SQL Database Developer Workshop](https://github.com/Azure-Samples/azure-sql-db-developers-workshop): full Stack workshop that exposes developers to local development, CICD, REST, GraphQL and cloud services
