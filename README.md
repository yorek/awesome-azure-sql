...
- :robot: [Build a Session Recommender with Azure SQL database and OpenAI](https://github.com/Azure-Samples/azure-sql-db-session-recommender): An end-to-end sample to show how to do vector similarity search on your own data in Azure SQL
